...
class DetailKelasScreen extends StatelessWidget {
  final String jurusanNama = "Seni Karawitan";
  final String logoPath = "assets/icons/sk_big.png";
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildKelasColumn("X", ["X SK"]),
                    _buildKelasColumn("XI", ["XI SK"]), // contoh, sesuaikan
                    _buildKelasColumn("XII", ["XII SK"]),
                  ],
                ),
              ),
