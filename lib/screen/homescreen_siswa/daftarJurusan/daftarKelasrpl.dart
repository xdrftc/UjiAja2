...
class DetailKelasScreen extends StatelessWidget {
  final String jurusanNama = "REKAYASA PERANGKAT LUNAK";
  final String logoPath = "assets/icons/rpl_big.png";
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildKelasColumn("X", ["X RPL 1", "X RPL 2"]),
                    _buildKelasColumn("XI", [
                      "XI RPL 1",
                      "XI RPL 2",
                    ]), // contoh, sesuaikan
                    _buildKelasColumn("XII", ["XII RPL 1", "XII RPL 2"]),
                  ],
                ),
              ),
