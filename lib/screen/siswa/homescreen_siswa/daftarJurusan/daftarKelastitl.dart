...
class DetailKelasScreen extends StatelessWidget {
  final String jurusanNama = "Teknik Instalasi Tenaga Listrik";
  final String logoPath = "assets/icons/titl_big.png";
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildKelasColumn("X", ["X TITL 1", "X TITL 2"]),
                    _buildKelasColumn("XI", [
                      "XI TITL 1",
                      "XI TITL 2",
                    ]), // contoh, sesuaikan
                    _buildKelasColumn("XII", ["XII TITL 1", "XII TITL 2"]),
                  ],
                ),
              ),
