...
class DetailKelasScreen extends StatelessWidget {
  final String jurusanNama = "TEKNIK KOMPUTER JARINGAN";
  final String logoPath = "assets/icons/tkj_big.png";
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildKelasColumn("X", ["X TKJ 1", "X TKJ 2"]),
                    _buildKelasColumn("XI", [
                      "XI TKJ 1",
                      "XI TKJ 2",
                    ]), // contoh, sesuaikan
                    _buildKelasColumn("XII", ["XII TKJ 1", "XII TKJ 2"]),
                  ],
                ),
              ),
